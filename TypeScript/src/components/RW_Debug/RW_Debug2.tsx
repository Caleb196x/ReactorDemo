    ...
    render() {
        ...
        return <div>
            ...
            <div style={{flexDirection: "row"}}>
                ...
                <button onClick={() => {console.log("Recording")}} style={{marginLeft: "20px"}}>Recording</button>
                <button onClick={() => {console.log("Stop")}} style={{marginLeft: "20px"}}>Stop</button>
                <button onClick={() => {console.log("Exit")}} style={{alignSelf: "end"}}>Exit</button>
                <span style={{visibility:  "visible", margin: "0 20px 0 50px"}}>录制中...</span>
            </div>
